...
Route::group(function () {
    ...
    Route::group('store/product', function () {
        ...
        Route::get('qrcode/:id', '/qrcode')->name('merchantStoreProductAttrValue')->option([
            '_alias' => '预览码',
        ]);
    ...
    Route::group('ad/', function (){
        Route::post('create','/create')->name('merchantStoreAdCreate')->option([
            '_alias' => '添加',
        ]);
        Route::post('update/:id','/update')->name('merchantStoreAdUpdate')->option([
            '_alias' => '编辑',
        ]);
        Route::post('proportion/:id','/proportion')->name('merchantStoreAdproportion')->option([
            '_alias' => '编辑回传比例',
        ]);
        Route::get('lst/:goods_id','/lst')->name('merchantStoreAdLst')->option([
            '_alias' => '列表',
        ]);
        Route::get('detail/:id','/detail')->name('merchantStoreAdDetail')->option([
            '_alias' => '详情',
        ]);
        Route::get('qrcode','/qrcode')->name('merchantStoreAdQrcode')->option([
            '_alias' => '预览',
        ]);
    })->prefix('merchant.store.product.Ad')->option([
        '_path' => '/product/ad',
        '_auth' => true,
    ]);
