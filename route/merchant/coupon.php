...
Route::group(function () {
    ...
    Route::group('merchant/coupon', function () {
        ...
        // 商家券批次详情
        Route::get('stock-detail/:id', 'merchant.coupon.StockDetail/detail')->name('merchantCouponStockDetail')->option([
            '_alias' => '商家券批次详情',
        ]);

        Route::post('add', 'merchant.coupon.PreCreateStock/preCreate')->name('merchantCouponPreCreate')->option([
            '_alias' => '创建商家券',
        ]);

        // 建券
        Route::post('create', 'merchant.coupon.CreateCoupon/create')->name('merchantCouponCreate')->option([
            '_alias' => '商家券发布',
        ]);
