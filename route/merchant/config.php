...
Route::group(function () {
     ...
     * new
     */
    Route::get('configInfo', 'admin.system.config.ConfigValue/info')->name('merchantConfigInfo')->option([
        '_alias' => '获取配置',
        '_path' => 'config',
        '_auth'  => false,
    ]);

    Route::post('setMerSetting', 'admin.system.config.ConfigValue/setMerSetting')->name('merchantsSetMerSetting')->option([
        '_alias' => '获取配置',
        '_path' => 'config',
        '_auth'  => false,
    ]);
