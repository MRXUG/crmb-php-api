...
Route::group(function () {
    ...
    Route::group( function () {
        ...
        Route::post('upload/certificate', 'merchant.Common/uploadCertificate')->name('merConfigUploadLicense')->option([
            '_alias' => '上传营业执照']);
        Route::post('upload/video', 'merchant.Common/uploadVideo');
        Route::post('upload/license', 'merchant.Common/uploadLicense');
    })->option([
        '_path' => '',
        '_auth'  => false,
    ]);
    ...
    Route::group( function () {
        ...
        Route::get('correlation/from/:id', 'merchant.system.Merchant/correlationForm')->name('merchantUpdate')->option([
            '_alias' => '关联主体弹窗',
        ]);
        Route::post('correlation/create', 'merchant.system.Merchant/createCorrelation')->name('createCorrelation')->option([
            '_alias' => '提交关联主体',
        ]);
        Route::post('correlation/save/:id', 'merchant.system.Merchant/saveCorrelation')->name('saveCorrelation')->option([
            '_alias' => '编辑关联主体',
        ]);
        Route::delete('correlation/delete/:id', 'merchant.system.Merchant/deleteCorrelation')->name('deleteCorrelation')->option([
            '_alias' => '删除关联主体',
        ]);
    })->option([
