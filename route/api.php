...
Route::group('api/', function () {
    ...
    Route::group(function () {
        ...
        Route::group('merchant/coupon', function () {
            ...
            // 券-核销
            Route::post('use', 'api.coupon.UseCoupon/use');
            // 退券
            Route::post('return', 'api.coupon.ReturnCoupon/return');
            // 推优
        ...
        //订单
        // 使用失败优惠啊，删除原有订单
        Route::delete('order/failure-remove/:groupOrderId', 'api.store.order.RemovePayFailureOrder/remove');
    ...
    Route::group(function () {
        ...
        Route::group('service', function () {
            // 平台客服
            Route::get('customer/service', 'api.store.service.Service/customerService');
            // 商户客服
            Route::get('customer/service/:merId', 'api.store.service.Service/customerService');
        });
        // 付费会员
        Route::group('svip', function () {
            //价格列表
        ...
        Route::group('store/merchant/', function () {
            ...
            Route::get('/info/:id', 'Merchant/newDetail');
    ...
    //记录用户访问日志
    Route::post('user/visit_log', 'api.server.UserLogController/visit')->name('UserVisitLog');
    ...
    //小程序支付回调
    Route::any('notice/routine_pay/:merId', 'api.Common/routineNotify')->name('routineNotify');
    //支付宝支付回调
    ...
    //登录
    Route::post('auth', 'api.Auth/authLogin')->middleware(UserTokenMiddleware::class, false);
