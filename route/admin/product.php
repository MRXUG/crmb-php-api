...
Route::group(function () {
    ...
    Route::group('store/product', function () {
        ...
        Route::get('qrcode/:id', '/qrcode')->name('systemStoreProductLabels')->option([
            '_alias' => '商品码',
            ]);
        Route::get('adLst/:id', '/adLst')->name('systemStoreProductAdLst')->option([
            '_alias' => '商品广告',
        ]);
        Route::get('ad/qrcode','/adQrcode')->name('systemStoreAdQrcode')->option([
            '_alias' => '预览',
        ]);
