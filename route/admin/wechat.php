...
Route::group(function () {
    Route::group('config/setting', function () {
        ...
        Route::post('upload_cert/:field/:merId', '/uploadCert')->name('configUploadCert')->option([
            '_alias' => '上传文件',
        ]);
        Route::post('upload_license/:field', '/uploadLicense')->name('configUploadLicense')->option([
            '_alias' => '上传营业执照',
        ]);

        Route::post('upload_cert/:field', '/uploadCert')->name('configUploadCert')->option([
            '_alias' => '上传文件',
        ]);
