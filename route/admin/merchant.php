...
Route::group(function () {
    ...
    Route::group('system/merchant', function () {
        ...
        Route::get('getMerchantPayInfo/:id', '.Merchant/getMerchantPayInfo')->name('systemGetMerchantPayInfo')->option([
            '_alias' => '获取商家微信支付商户号',
            '_auth' => false,
        ]);
        Route::post('saveMerchantPayInfo/:id', '.Merchant/saveMerchantPayInfo')->name('systemSaveMerchantPayInfo')->option([
            '_alias' => '设置商家微信支付商户号',
            '_auth' => false,
        ]);
    ...
    // 收益
    Route::group('merchant/profit', function () {
        //列表
        Route::get('lst', '/lst')->name('systemMerchantProfitLst')->option([
            '_alias' => '收益列表',
        ]);
        // 列表导出
        Route::get('export', '/export')->name('systemMerchantProfitLstExport')->option([
            '_alias' => '收益列表导出',
        ]);
        // 总额
        Route::get('sum', '/sum')->name('systemMerchantProfitSum')->option([
            '_alias' => '收益总额',
        ]);
    })->prefix('admin.system.merchant.profit')->option([
        '_path' => '/merchant/profit_list',
        '_auth' => true,
    ]);
    // 货款
    Route::group('merchant/goodsPayment', function () {
        //列表
        Route::get('lst', '/lst')->name('systemMerchantGoodsPaymentLst')->option([
            '_alias' => '货款列表',
        ]);
        // 导出
        Route::get('export', '/export')->name('systemMerchantGoodsPaymentLstExport')->option([
            '_alias' => '货款列表导出',
        ]);
        // 服务费统计
        Route::get('serviceFeeStat', '/serviceFeeStat')->name('systemMerchantServiceFeeStat')->option([
            '_alias' => '服务费统计',
        ]);
        // 明细

    })->prefix('admin.system.merchant.goodsPayment')->option([
        '_path' => '/merchant/goods_payment_list',
        '_auth' => true,
    ]);
