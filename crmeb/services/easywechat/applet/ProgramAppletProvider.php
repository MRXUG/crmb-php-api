 ...
 * @package crmeb\utils
 */
class ProgramAppletProvider implements ServiceProviderInterface
{
    public function register(Container $pimple)
    {
        ...
        $pimple['mini_program.applet'] = function ($pimple) {
            return new ProgramApplet($pimple['mini_program.access_token']);
        };
    }
}
