...
class WechatService
{
    ...
    public static function getV3PayConfig($merId, $appId = '')
    {
        $payment = merchantConfig($merId, [
            ...
            'pay_routine_appsecret',
            'pay_routine_appid'
            
        ]);

        return [
            'app_id' => $appId ?? $payment['pay_routine_appid'],
            // 'secret' => $payment['pay_routine_appsecret'],
            'service_payment' => [
                ...
                // 'pay_weixin_client_cert' => $payment['pay_routine_client_key'],
     ...
     * @date    2023/3/3 14:58
     */
    public static function getMerPayObj($merId, $appId = '')
    {
        // 获取商户配置
        $merPayConfig = WechatService::getV3PayConfig($merId, $appId);
    ...
    {
        return $this->application->certficates;
    }
    ...
    public static function getConfig($isApp)
    {
        ...
        $payment = $make->more(['site_url', 'pay_weixin_mchid', 'pay_weixin_client_cert', 'pay_weixin_client_key', 'pay_weixin_key', 'pay_weixin_v3_key', 'pay_weixin_open',
        ...
        if (isset($payment['pay_weixin_open']) && $payment['pay_weixin_open'] == 1) {
            $config['payment'] = [
                ...
                'v3_key' => trim($payment['pay_weixin_v3_key']),
    ...
    public function jsSdk($url)
    {
        ...
        /*print_r((new UserOpenIdRelationDao())->routineOpenIdByWhere([
            'id' => 1,
        ]));
        return [];*/
    ...
    */
     ...
     * 商户分账、服务商分账
     *
     * @return \crmeb\services\easywechat\profitSharing\Client
     * @author  zouxiuhui <zouxiuhui@vchangyi.com>
     * @date    2023/3/2 9:58
     */
