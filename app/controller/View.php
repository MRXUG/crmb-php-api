...
class View extends BaseController
{
    ...
    public function h5()
    {
        if ((!$this->request->isMobile()) && (!$this->request->param('inner_frame')) && !strpos($this->request->server('HTTP_USER_AGENT'), 'MicroMessenger')) {
            return $this->mobile();
        }
    ...
    {
        return view(app()->getRootPath() . 'public' . DIRECTORY_SEPARATOR . $file);
    }
}
