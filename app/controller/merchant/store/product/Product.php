...
class Product extends BaseController
{
    ...
    /**
     * @var ProductStockSetRepository
     */
    private $stockSetRepository;

    /**
     * Product constructor.
     * @param App $app
     * @param repository $repository
     * @param ProductAttrValueRepository $attrValueRepository
     */
    public function __construct(App $app ,repository $repository, ProductStockSetRepository $stockSetRepository)
    {
