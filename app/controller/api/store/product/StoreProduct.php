...
class StoreProduct extends BaseController
{
     ...
     * @param  \app\common\repositories\system\merchant\MerchantAdRepository  $adRepository
     */
    public function __construct(App $app, repository $repository, MerchantAdRepository $adRepository)
    {
