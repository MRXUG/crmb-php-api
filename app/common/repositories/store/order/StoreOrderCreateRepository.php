...
//                'discount_num' => $orderMerchantCoupon['discount_num'] ?? 0, // 商家券面额
     ...
     */
    public function validateMarketingDiscount($uid, $merId, array $marketingDiscount, $order)
    {
...
//            }
     ...
     * @return int[]
     */
    private function tellOrderSource(int $adId, array $adInfo, array $goodsInfo, bool $isUseDiscount, bool $isCardPackage = false) : array
    {
