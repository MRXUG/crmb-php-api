...
return [
    ...
    'block_puzzle' => [
        ...
        'backgrounds' => [
            app()->getRootPath() . "public/uploads/ajcaptcha/1.jpg",
            app()->getRootPath() . "public/uploads/ajcaptcha/2.jpg",
            app()->getRootPath() . "public/uploads/ajcaptcha/3.jpg",
            app()->getRootPath() . "public/uploads/ajcaptcha/4.jpg",
            app()->getRootPath() . "public/uploads/ajcaptcha/5.jpg",
            app()->getRootPath() . "public/uploads/ajcaptcha/6.jpg",
        ],
